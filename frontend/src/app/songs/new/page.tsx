        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSaving ? (
                <>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 border border-indigo-100">
          ...
          <div className="relative">
            <input
              ...
              className="block w-full pl-4 pr-4 py-3 border border-indigo-200 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-indigo-50 text-lg font-medium placeholder-gray-400"
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6 border border-indigo-100">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Song Settings</h2>
              </div>
              <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-indigo-100">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Chord Progression</h2>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6 border border-indigo-100">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Song Structure</h2>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-indigo-100">
              ...
              <div className="relative">
                <textarea
                  ...
                  rows={4}
                  className="block w-full pl-4 pr-4 py-3 border border-indigo-200 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-indigo-50 text-sm placeholder-gray-400 resize-none"
